...
csv_file_path = '/home/khudi/Desktop/EcommerceAgentProject/customerDetail.csv'
...
# select_query = f'SELECT * FROM {table_name} where customerID = "9c9c2648-d067-4c33-a5cf-3530465353fc";'
...
#                 'customerID': row[2],
#                 'address': row[3],
#                 'interested_category': row[4],
#                 'past_purchase_category': row[5],
#                 'past_purchase': row[6],
